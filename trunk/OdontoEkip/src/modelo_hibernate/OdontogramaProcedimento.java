 ...
 */
@Entity
@Table(name = "tb_odontograma_procedimento", catalog = "odonto", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "OdontogramaProcedimento.findAll", query = "SELECT o FROM OdontogramaProcedimento o"),
    @NamedQuery(name = "OdontogramaProcedimento.findByCodigoOdontogramaProcedimeto", query = "SELECT o FROM OdontogramaProcedimento o WHERE o.codigoOdontogramaProcedimeto = :codigoOdontogramaProcedimeto"),
    @NamedQuery(name = "OdontogramaProcedimento.findByStatusPagamento", query = "SELECT o FROM OdontogramaProcedimento o WHERE o.statusPagamento = :statusPagamento"),
    @NamedQuery(name = "OdontogramaProcedimento.findByDataPagamento", query = "SELECT o FROM OdontogramaProcedimento o WHERE o.dataPagamento = :dataPagamento")})
