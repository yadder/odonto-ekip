 ...
 */
@Entity
@Table(name = "tb_paciente", catalog = "odonto", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Paciente.findAll", query = "SELECT p FROM Paciente p"),
    @NamedQuery(name = "Paciente.findByResponsavelPaciente", query = "SELECT p FROM Paciente p WHERE p.responsavelPaciente = :responsavelPaciente"),
    @NamedQuery(name = "Paciente.findByLogradouroPaciente", query = "SELECT p FROM Paciente p WHERE p.logradouroPaciente = :logradouroPaciente"),
    @NamedQuery(name = "Paciente.findByNumeroLogradouroPaciente", query = "SELECT p FROM Paciente p WHERE p.numeroLogradouroPaciente = :numeroLogradouroPaciente"),
    @NamedQuery(name = "Paciente.findByComplementoLogradouroPaciente", query = "SELECT p FROM Paciente p WHERE p.complementoLogradouroPaciente = :complementoLogradouroPaciente"),
    @NamedQuery(name = "Paciente.findByBairroPaciente", query = "SELECT p FROM Paciente p WHERE p.bairroPaciente = :bairroPaciente"),
    @NamedQuery(name = "Paciente.findByCidadePaciente", query = "SELECT p FROM Paciente p WHERE p.cidadePaciente = :cidadePaciente"),
    @NamedQuery(name = "Paciente.findByEstadoPaciente", query = "SELECT p FROM Paciente p WHERE p.estadoPaciente = :estadoPaciente"),
    @NamedQuery(name = "Paciente.findByCepPaciente", query = "SELECT p FROM Paciente p WHERE p.cepPaciente = :cepPaciente"),
