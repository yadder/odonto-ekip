...
public class DaoOdontogramaProcedimentoImp implements DaoOdontogramaProcedimento {
	...
	public OdontogramaProcedimento pesquisarOdontogramaProcedimento(OdontogramaProcedimento odontogramaProcedimento) {
		...
		try {
			session = HibernateUtil.getSessionFactory().openSession();
			e = (OdontogramaProcedimento)session.get(OdontogramaProcedimento.class, odontogramaProcedimento.getCodigoOdontogramaProcedimeto());
