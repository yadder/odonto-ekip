 ...
 */
@Entity
@Table(name = "tb_dentista", catalog = "odonto", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Dentista.findAll", query = "SELECT d FROM Dentista d"),
    @NamedQuery(name = "Dentista.findByCroDentista", query = "SELECT d FROM Dentista d WHERE d.croDentista = :croDentista"),
    @NamedQuery(name = "Dentista.findByCodigoDentista", query = "SELECT d FROM Dentista d WHERE d.codigoDentista = :codigoDentista")})
