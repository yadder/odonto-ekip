...
<h1>:: Relatório de Consultas por Status e data</h1>
<div id="msg">
	<h5 class="information">${msg}</h5>
	<h5 class="error">${msgE}</h5>
</div>

<form name="formRelatorioConsultaStatusPorData" method="post" action="ServletRelatorio">
	<table>
		<tr>
		...
		<tr>
			...
			<td colspan=2 align="center">
				...
				<input type="submit" name="btn" value="Gerar Consultas por Status Data" />				
			</td>
		</tr>		
	</table>
</form>	
